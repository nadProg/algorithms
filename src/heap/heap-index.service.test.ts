...
describe('HeapIndexService', () => {
  ...
  describe('getParentIndex', () => {
    test('for index = -1 should return null', () => {
      const index = -1;
      const parentIndex = heapIndexService.getParentIndexByChildIndex(index);
  ...
  describe('getFirstChildIndex', () => {
    test('for index = 0 should return 1', () => {
      ...
      const firstChildIndex =
        heapIndexService.getFirstChildIndexByParentIndex(index);
  ...
  describe('getSecondChildIndex', () => {
    test('for index = 0 should return 2', () => {
      const index = 0;
      const secondChildIndex =
        heapIndexService.getSecondChildIndexByParentIndex(index);
