  ...
  describe('Default (Max) heap', () => {
    ...
    describe('Nodes 0 1 2 3 4 5 6', () => {
      ...
      describe('extractRootNode', () => {
        ...
        test.skip('getRootNode after extraction should return 5', () => {
          const rootNode = heap.getRootNode();
    ...
    describe('Nodes 0 1 2 3 4 5', () => {
      ...
      describe('extractRootNode', () => {
        ...
        test.skip('getRootNode after extraction should return 4', () => {
          const rootNode = heap.getRootNode();
    ...
    describe('Nodes 0 1 2 3 4', () => {
      ...
      describe('extractRootNode', () => {
        ...
        test.skip('getRootNode after extraction should return 3', () => {
          const rootNode = heap.getRootNode();
          expect(rootNode).toBe(3);
        });
      });
  ...
  describe('Min heap', () => {
    ...
    describe('Nodes 0 1 2 3 4 5 6', () => {
      ...
      describe('extractRootNode', () => {
        ...
        test.skip('getRootNode after extraction should return 1', () => {
          const rootNode = heap.getRootNode();
          expect(rootNode).toBe(1);
        });
      });
